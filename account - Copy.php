    ...
    <div class="wrapper">
        <div class="top_navbar">
            ...
            <div class="top_menu">
                ...
                <ul>
                <li><span class="pull-right top title1" ><a href="logout.php?q=account.php" style="color:lightyellow"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;</button></a></span>';
                </li>
