        ...
        <div class="containdiv">
            <div class="left">
                <section class="summaryitems">
                    ...
                    <h4 style="padding-left: 25px;padding-top:5px"><a href="student_workspace_session.html"> >> Click <u>here</u> to enter your Workspace</a></h4>

                </section>

                <section class="summaryitems">
                    <h3 style="padding-left: 5px;padding-top:5px">Announcements:</h3>
                    <br />
                    <br />
                </section>

                <section class="summaryitems">
                    <h3 style="padding-left: 5px;padding-top:5px">Your Upcoming Submissions:</h3>
                    <br />
                    <br />
                </section>
            ...
            <div class="right">
                ...
                <section class="courses">
                    <h4 style="padding-left: 5px;padding-top:5px;color:black"><a href="student_course_detail_pg1.html">INFS3617: Networking and Cyber Security </a></h4>
                    <p style="padding-left: 5px;color:blue">
                ...
                <section class="courses">
                    <h4 style="padding-left: 5px;padding-top:5px;color:black"><a href="staff_course_detail_pg2.html">INFS3605: Information Systems Innovation and Transformation</a></h4>
                    <p style="padding-left: 5px;color:blue">
                ...
                <section class="courses">
                    <h4 style="padding-left: 5px;padding-top:5px;color:black"><a href="staff_course_detail_pg1.html">INFS3830: Social Media and Analytics</a></h4>
                    <p style="padding-left: 5px; padding-bottom:50px;color:blue">
